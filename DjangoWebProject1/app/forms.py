...
class ReviewForm(forms.Form):
    ...
    internet = forms.ChoiceField(label='Вы пользуетесь интернетом' , choices=(('1', 'Ежедневно'),('2','Пару часов в день'),('3','Пару часов в неделю'),('4','Пару часов в месяц')), initial=1)
    notice = forms.BooleanField(label='Получить новости сайта на e-mail?' , required=False)
